...
<head>
    ...
    <!-- Title Page-->
    <title>Tabungan Rahmah | Badan Usaha</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <br>
                    <h2 style="padding-left: 30px;" class="title">Pembukaan Tabungan Rahmah (BU)</h2>
                </div>
                <div class="card-body">
                    <form method="post" action="/tabungan/jenis/badan-usaha/rahmah">
                        @csrf
                        <div class="form-row">
