    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="form-group">
                <button type="submit" class="form-control btn btn-primary rounded submit px-3"><a href="{{ url('/tabungan/jenis/individu') }}" style="color: #fff;">Individu</a></button>
            </div>

            <div class="form-group">
                <button type="submit" class="form-control btn btn-primary rounded submit px-3"><a href="{{ url('/tabungan/jenis/badan-usaha') }}" style="color: #fff;">Badan Usaha</a></button>
            </div>
