...
<head>
    ...
    <!-- Title Page-->
    <title>Tabungan Simapan | Individu</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <br>
                    <h2 style="padding-left: 30px;" class="title">Pembukaan Tabungan Simapan</h2>
                </div>
                <div class="card-body">
                    <form method="post" action="/tabungan/jenis/individu/simapan" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
