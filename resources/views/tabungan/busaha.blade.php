    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="form-group">
                <button type="submit" class="form-control btn btn-primary rounded submit px-3"><a href="{{ url('/tabungan/jenis/badan-usaha/rahmah') }}" style="color: #fff;">Tabungan Rahmah</a></button>
            </div>

            {{-- <div class="form-group">
                <button type="submit" class="form-control btn btn-primary rounded submit px-3"><a href="{{url('/tabungan/jenis/badan-usaha/amanah')}}" style="color: #fff;">Tabungan Amanah</a></button>
            </div> --}}
