...
<div class="app-main__outer">
    <div class="app-main__inner">
                    ...
                    <div class="d-inline-block dropdown">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="/rahmah/exportpdf" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="/rahmah/exportxls" class="nav-link" target="_blank">
        ...
        <div class="row">
            ...
            <form action="/admin/rahmah/cari" method="post">
                @csrf
                            ...
                            <table class="mb-0 table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/admin/rahmah/{{$rhm->id}}"><button type="button" class="btn btn-success">detail</button></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        <div class="row">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                <li class="page-item"><a class="page-link" href="{{ $rahmah->previousPageUrl() }}">Previous</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->previousPageUrl() }}">{{$rahmah->currentPage() -1}}</a></li> --}}
                <li class="page-item active"><a class="page-link" href="#">{{$rahmah->currentPage()}}</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->nextPageUrl() }}">{{$rahmah->currentPage() +1}}</a></li> --}}
                <li class="page-item"><a class="page-link" href="{{ $rahmah->nextPageUrl() }}">Selanjutnya</a></li>
                </ul>
            </nav>
        </div>
    </div>
