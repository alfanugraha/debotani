...
<div class="app-main__outer">
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>SIMAPAN
                        <div class="page-title-subheading">Ini daftar nasabah SIMAPAN
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-inline-block dropdown">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="/simapan/exportpdf" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="/simapan/exportxls" class="nav-link">
        ...
        <div class="row">
            ...
            <form action="/admin/simapan/cari" method="post">
                @csrf
                            ...
                            <table class="mb-0 table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/admin/simapan/{{$rhm->id}}"><button type="button" class="btn btn-success">detail</button></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        <div class="row">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                <li class="page-item"><a class="page-link" href="{{ $simapan->previousPageUrl() }}">Previous</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->previousPageUrl() }}">{{$rahmah->currentPage() -1}}</a></li> --}}
                <li class="page-item active"><a class="page-link" href="#">{{$simapan->currentPage()}}</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->nextPageUrl() }}">{{$rahmah->currentPage() +1}}</a></li> --}}
                <li class="page-item"><a class="page-link" href="{{ $simapan->nextPageUrl() }}">Selanjutnya</a></li>
                </ul>
            </nav>
        </div>
    </div>
