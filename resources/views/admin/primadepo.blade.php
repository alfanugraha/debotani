...
<div class="app-main__outer">
    <div class="app-main__inner">
                    ...
                    <div class="d-inline-block dropdown">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="/prima/exportpdf" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="/prima/exportxls" class="nav-link">
        ...
        <div class="row">
            <p>Cari Data Badan Usaha :&nbsp;</p>
            <form action="/admin/prima/cari" method="post">
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="mb-0 table">
                                ...
                                <tbody>
                                    @foreach ($primadepo as $rhm)
                                    <tr>
                                        <th scope="row">{{ $rhm->id }}</th>
                                        <td>{{ $rhm->nama_usaha }}</td>
                                        <td>{{ $rhm->jenis_usaha }}</td>
                                        <td>{{ $rhm->telp }}</td>
                                        <td>{{ $rhm->fax }}</td>
                                        <td>{{ $rhm->alamat }}</td>
                                        <td>{{ $rhm->izin }}</td>
                                        ...
                                        <td><a href="/admin/prima/{{$rhm->id}}"><button type="button" class="btn btn-success">detail</button></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
        ...
        <div class="row">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                <li class="page-item"><a class="page-link" href="{{ $primadepo->previousPageUrl() }}">Previous</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->previousPageUrl() }}">{{$rahmah->currentPage() -1}}</a></li> --}}
                <li class="page-item active"><a class="page-link" href="#">{{$primadepo->currentPage()}}</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->nextPageUrl() }}">{{$rahmah->currentPage() +1}}</a></li> --}}
                <li class="page-item"><a class="page-link" href="{{ $primadepo->nextPageUrl() }}">Selanjutnya</a></li>
                </ul>
            </nav>
        </div>
    </div>
