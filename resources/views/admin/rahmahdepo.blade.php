...
<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="row">
            ...
            <form action="/admin/individu/cari" method="post">
                @csrf
        ...
        <div class="row">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                <li class="page-item"><a class="page-link" href="{{ $rahmahdepo->previousPageUrl() }}">Previous</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->previousPageUrl() }}">{{$rahmah->currentPage() -1}}</a></li> --}}
                <li class="page-item active"><a class="page-link" href="#">{{$rahmahdepo->currentPage()}}</a></li>
                {{-- <li class="page-item"><a class="page-link" href="{{ $rahmah->nextPageUrl() }}">{{$rahmah->currentPage() +1}}</a></li> --}}
                <li class="page-item"><a class="page-link" href="{{ $rahmahdepo->nextPageUrl() }}">Selanjutnya</a></li>
                </ul>
            </nav>
        </div>
    </div>
