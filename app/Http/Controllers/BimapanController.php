...
class BimapanController extends Controller
{
    public function create()
    {
        return view('tabungan.bimapan');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Bimapan::create($request->all());

        return redirect('/')->with('status' ,'Data nasabah BIMAPAN berhasil ditambah.');
    }
}
