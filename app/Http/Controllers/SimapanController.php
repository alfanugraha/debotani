...
class SimapanController extends Controller
{
    public function create()
    {
        return view('tabungan.simapan');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Simapan::create($request->all());

        return redirect('/')->with('status' ,'Data nasabah Simapan berhasil ditambah.');
    }
}
